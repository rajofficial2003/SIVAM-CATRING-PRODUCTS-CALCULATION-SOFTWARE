...
const GeneralItemsForm = () => {
  const [items, setItems] = useState([
    ...
    { id: 43, tamilName: 'புளர் பீன்ஸ்', englishName: 'Flower Beans', kg: '', grams: '' },
    ...
    { id: 51, tamilName: 'சிம்பல் அப்பளம்', englishName: 'Simple Appalam', kg: '', grams: '' },
    ...
    { id: 70, tamilName: 'ரஸ்னா குளிர்பானம்', englishName: 'Rasna Cool Drink', kg: '', grams: '' },
    { id: 71, tamilName: 'பேக்கிங் படல்', englishName: 'Baking Powder', kg: '', grams: '' },
    { id: 72, tamilName: 'ஆப்ப சோடா', englishName: 'Appa Soda', kg: '', grams: '' },
    { id: 73, tamilName: 'லெமன் சால்ட்', englishName: 'Lemon Salt', kg: '', grams: '' },
    { id: 74, tamilName: 'அஜினாமோட்டோ', englishName: 'Ajinomoto', kg: '', grams: '' },
    { id: 75, tamilName: 'கல் உப்பு (டாடா)', englishName: 'Rock Salt (Tata)', kg: '', grams: '' },
    { id: 76, tamilName: 'சால்ட் உப்பு', englishName: 'Table Salt', kg: '', grams: '' },
    { id: 77, tamilName: 'ரோல் பண் (ரொட்டி)', englishName: 'Roll Bun (Bread)', kg: '', grams: '' },
    { id: 78, tamilName: 'தேன் பாட்டில்', englishName: 'Honey Bottle', kg: '', grams: '' },
    { id: 79, tamilName: 'பெரிச்சம்பழம் (லயன்)', englishName: 'Dates (Lion)', kg: '', grams: '' },
